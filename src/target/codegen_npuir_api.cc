...
void CodeGenTileLangNPUIRAPI::DotCodegen(const CallNode *op) {
  ...
  mlir::Value a = GenRankReducedSubviewFromRegion(npuirop.src0, npuirop.src0_range, /*min_rank=*/2);
  mlir::Value b = GenRankReducedSubviewFromRegion(npuirop.src1, npuirop.src1_range, /*min_rank=*/2);
